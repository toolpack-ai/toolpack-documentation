...
description: "Overview of the @toolpack-sdk/agents package — build production-ready AI agents with channels, interceptors, conversation history, and multi-agent coordination."
keywords: [agents, AI agents, BaseAgent, channels, interceptors, conversation history, multi-agent, toolpack agents]
---
