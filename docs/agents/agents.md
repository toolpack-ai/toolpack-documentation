...
description: "Create custom AI agents by extending BaseAgent. Covers required properties, constructor options, invokeAgent, run(), lifecycle hooks, and built-in concrete agents."
keywords: [BaseAgent, invokeAgent, run, lifecycle hooks, ModeConfig, ResearchAgent, CodingAgent, DataAgent, BrowserAgent]
---
