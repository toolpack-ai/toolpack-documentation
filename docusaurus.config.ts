  ...
  headTags: [
    // JSON-LD structured data for rich search results
    {
      ...
      innerHTML: JSON.stringify({
        ...
        name: 'Toolpack SDK',
        description: 'A unified TypeScript SDK for building AI-powered applications with OpenAI, Anthropic, Gemini, and Ollama. 100+ built-in tools, multi-provider support, and zero vendor lock-in.',
        url: 'https://toolpacksdk.com',
